...
public class InvoiceServiceJPA implements InvoiceService {
    ...
    @Override
    public List<Invoice> findUnpaidInvoices(LocalDate actualDate) {
        return invoiceRepository.findUnpaidInvoices(actualDate);
    }
    ...
    public Invoice issueInvoice(Invoice invoice) {
        ...
        price.setPrice(contract.getPrice().getPrice());
