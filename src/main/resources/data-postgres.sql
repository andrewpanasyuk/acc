...
VALUES
    ...
    (7, '2017-06-20', 6, 2, 'POSTPAY', 5, 2, '2014-11-13'),
    (8, '2017-06-25', 11, 1, 'TRIAL', 5, 2, '2017-07-13'),
    (9, '2017-06-30', 12, 3, 'TRIAL', 5, 2, '2014-07-30');

INSERT INTO invoice (id, creation_date, employee_paid, period_from, period_to, contract_id, price_id) VALUES
    (1, '2017-06-01', FALSE, '2017-06-01', '2017-06-30', 1, 1),
    (2, '2017-05-01', FALSE, '2017-06-01', '2017-07-10', 2, 2),
    (3, '2017-05-01', FALSE, '2017-06-01', '2017-07-01', 3, 3),
