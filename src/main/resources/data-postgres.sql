...
INSERT INTO payment (id, invoice_id, date_paid, created_by, created_date, sum_id) VALUES
    (1, 1, now() - interval '3 mon', 'system', '2017-07-11', 20),
    (2, 2, now() - interval '2 mon', 'system', '2017-07-11', 21),
    (3, 3, now() - interval '1 mon', 'system', '2017-07-11', 22),
    (4, 5, now() - interval '2 mon + 13 day', 'system', '2017-07-11', 23),
    (5, 6, now() - interval '1 mon + 12 day', 'system', '2017-07-11', 24),
    (6, 7, now() - interval '11 day', 'system', '2017-07-11', 25),
    (7, 8, now() - interval '1 mon + 4 day', 'system', '2017-07-11', 26),
    (8, 9, now() - interval '2 mon + 11 day', 'system', '2017-07-11', 27),
    (9, 10, now() - interval '1 mon + 10 day', 'system', '2017-07-11', 28);
...
INSERT INTO salary_item(id, salary_id, employee_id, invoice_id, employee_payment_id, date_from, date_to, accounted) VALUES
    ...
    (2, null, 1, 2, 22, now() - interval '3 mon', now() - interval '2 mon', FALSE),
    (3, null, 1, 3, 22, now() - interval '2 mon', now() - interval '1 mon', FALSE),
    (4, null, 1, 4, 22, now() - interval '1 mon', now(), FALSE),
